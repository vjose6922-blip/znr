...
const widget = document.getElementById('weather-widget');
if (widget) {
widget.innerHTML = '<span class="weather-icon"></span><span class="weather-temp">Cargando...</span>';
