...
card.innerHTML = `
<div class="product-slider" style="position:relative;cursor:pointer;aspect-ratio:1/1;overflow:hidden;display:flex;align-items:center;justify-content:center;background:var(--color-surface-2,#f5f5f8);">
