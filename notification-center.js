(function () {
  ...
  const TIPO_INFO = {
    ...
    beneficiario_editado:   { grupo: 'cuenta',  icono: Icon('edit') },
    beneficiario_eliminado: { grupo: 'cuenta',  icono: Icon('trash') },
    edicion_rechazada:      { grupo: 'cuenta',  icono: Icon('ban') },
    eliminacion_rechazada:  { grupo: 'cuenta',  icono: Icon('ban') },
