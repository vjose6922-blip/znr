// SVG icon strings for notifications-optimized.js
...
showTemporaryMessage("Usando datos guardados - Error de conexión", "error");
}
} else {
const container = document.getElementById("notifications");
if (container) {
...
<span class="meta-item"><svg xmlns="http://www.w3.org/2000/svg" width="13" height="13" fill="none" viewBox="0 0 24 24" stroke="currentColor" stroke-width="2"><path stroke-linecap="round" stroke-linejoin="round" d="M15 9h3.75M15 12h3.75M15 15h3.75M4.5 19.5h15a2.25 2.25 0 002.25-2.25V6.75A2.25 2.25 0 0019.5 4.5h-15a2.25 2.25 0 00-2.25 2.25v10.5A2.25 2.25 0 004.5 19.5zm6-10.125a1.875 1.875 0 11-3.75 0 1.875 1.875 0 013.75 0zm1.294 6.336a6.721 6.721 0 01-3.17.789 6.721 6.721 0 01-3.168-.789 3.376 3.376 0 016.338 0z"/></svg> ${escapeHtml(String(notif.productId))}</span>
<span class="meta-item"><svg xmlns="http://www.w3.org/2000/svg" width="13" height="13" fill="none" viewBox="0 0 24 24" stroke="currentColor" stroke-width="2"><path stroke-linecap="round" stroke-linejoin="round" d="M9.568 3H5.25A2.25 2.25 0 003 5.25v4.318c0 .597.237 1.17.659 1.591l9.581 9.581c.699.699 1.78.872 2.595.33a18.095 18.095 0 005.223-5.223c.542-.815.369-1.896-.33-2.595L9.568 3z"/></svg> ${escapeHtml(notif.talla || 'N/A')}</span>
<span class="meta-item"><svg xmlns="http://www.w3.org/2000/svg" width="13" height="13" fill="none" viewBox="0 0 24 24" stroke="currentColor" stroke-width="2"><path stroke-linecap="round" stroke-linejoin="round" d="M12 6v12m-3-2.818l.879.659c1.171.879 3.07.879 4.242 0 1.172-.879 1.172-2.303 0-3.182C13.536 11.219 12.768 11 12 11c-.768 0-1.536-.219-2.121-.659a2.25 2.25 0 010-3.182c.585-.44 1.353-.659 2.121-.659.768 0 1.536.219 2.121.659M12 6v1m0 12v-1"/></svg> $${(notif.precio || 0).toLocaleString()}</span>
<span class="meta-item"><svg xmlns="http://www.w3.org/2000/svg" width="13" height="13" fill="none" viewBox="0 0 24 24" stroke="currentColor" stroke-width="2"><path stroke-linecap="round" stroke-linejoin="round" d="M21 7.5l-9-5.25L3 7.5m18 0l-9 5.25m9-5.25v9l-9 5.25M3 7.5l9 5.25M3 7.5v9l9 5.25m0-9v9"/></svg> ${notif.cantidad}</span>
${!notif.hasStock ? `<span class="meta-item stock-warning">${_icWarn} Stock: ${notif.currentStock}</span>` : ''}
</div>
</div>
...
${notif.confiable ? _icStar : _icStarO}
</button>` : ''}
</div>
`).join('')}
</div>
...
`<button class="btn btn-secondary" data-action="remove-stock"><svg xmlns="http://www.w3.org/2000/svg" width="13" height="13" aria-hidden="true"><use href="#ic-trash"/></svg> sin stock (${group.unavailableCount})</button>` : ''}
${group.availableCount > 0 ?
`<button class="btn btn-confirm" data-action="confirm"><svg xmlns="http://www.w3.org/2000/svg" width="13" height="13" aria-hidden="true"><use href="#ic-check"/></svg> Confirmar (${group.availableCount})</button>` : ''}
