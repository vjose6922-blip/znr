...
<button onclick="loadProducts()" style="padding:10px 24px;border-radius:40px;border:none;background:var(--color-accent,var(--color-accent-solid));color:white;font-weight:600;cursor:pointer;font-size:14px;"><svg xmlns="http://www.w3.org/2000/svg" width="14" height="14" aria-hidden="true"><use href="#ic-refresh"/></svg> Reintentar</button>
</div>`;
}
